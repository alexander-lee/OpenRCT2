  ...
  const update =
    ((t: typeof THREE, g: THREE.Group) => {
        ...
        for (let i = 0; i < 8; i++) {
          ...
          ride.add(box(t, [0.1, 0.5, 0.02], GOLD, [Math.cos(a) * 0.35, 1.05, Math.sin(a) * 0.35], { metal: 0.6, rough: 0.3, rotY: Math.PI / 2 - a })); // thickness radial: panel lies FLUSH on the drum (0.34..0.36)
        }
        ...
        for (let i = 0; i < SEGS; i++) {
          ...
          const wedge = new t.Mesh(
            ...
            mat(t, i % 2 ? ORANGE : CREAM, { tex: 'fabric', repeat: [2, 2], rough: 0.6 }),
          );
        ...
        for (let i = 0; i < 18; i++) {
          ...
          const scallop = ball(t, 0.08, ORANGE, [Math.cos(a) * 1.8, 1.82, Math.sin(a) * 1.8], { flat: true, rough: 0.6 }); // scallops
        ...
        for (let i = 0; i < 18; i++) {
          ...
          bulb.position.set(Math.cos(a) * 1.81, 1.88, Math.sin(a) * 1.81);
          ride.add(bulb);
        }
        ...
        for (let i = 0; i < N; i++) {
          ...
          ride.add(cyl(t, 0.022, 0.022, 1.7, GOLD, [Math.cos(a) * 1.12, 1.15, Math.sin(a) * 1.12], { tex: 'metal', metal: 0.85, rough: 0.2, seg: 10 }));
