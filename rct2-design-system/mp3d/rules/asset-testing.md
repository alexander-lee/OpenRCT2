...
`mp3d/rules-archive/asset-testing.md` and is no longer shipped to the design system.**

Reason: harness asset-testing notes, not park generation. `rules/*.md` is never injected into a generation — only
