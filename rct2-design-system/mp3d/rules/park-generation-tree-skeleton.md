...
`mp3d/rules-archive/park-generation-tree-skeleton.md` and is no longer shipped to the design system.**

Reason: skeleton B (the tree) — one street table. `rules/*.md` is never injected into a generation — only
